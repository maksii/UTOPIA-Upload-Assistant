...
class Args():
    ...
    def parse(self, args, meta):
        ...
        parser = argparse.ArgumentParser(description="UTOPIA Upload Assistant")

        # File and directory handling
        parser.add_argument('path', nargs='*', help="Path to file/directory")
        
        # Media information arguments
        ...
        # Flags to modify title generation
