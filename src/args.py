...
class Args():
    ...
    def parse(self, args, meta):
        ...
        parser.add_argument('-ih', '--imghost', nargs='*', required=False, help="Image Host", choices=['utppm', 'imgbb', 'ptpimg', 'imgbox', 'pixhost', 'lensdump'])
        ...
        parser.add_argument('-mua', '--madeinua', nargs='*', required=False, help="Made in Ukraine?", default=0, dest="madeinua")
        parser.add_argument('-du', '--dubbing', nargs='*', required=False, help="Dubbing", default=0, dest="dubbing")
        parser.add_argument('-mo', '--moderation', nargs='*', required=False, help="Opt in to Moderation Queue", default=0, dest="Moderation")
